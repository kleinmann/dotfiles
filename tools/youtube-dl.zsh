...
alias youtube-video='youtube-dl -f bestvideo\[height\<=?1080\]+bestaudio/best\[height\<=?1080\]/best --prefer-free-formats -i --xattrs --external-downloader aria2c --external-downloader-args "-c -j 3 -x 3 -s 3 -k 1M"'
