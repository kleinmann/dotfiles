...
PROMPT=$'$fill
%{\e[0;34m%}%B┌─%{\e[0m%}%B[%b%{\e[0m%}%{\e[1;32m%}%n%{\e[1;30m%}@%{\e[0m%}%{\e[0;33m%}%m%{\e[0m%}%B]%b%{\e[0m%}:%b%{\e[0m%}%B[%b%{\e[1;37m%}%~%{\e[0m%}%B]%b%{\e[0m%} - %B(%b$(rvm_prompt_info)%B)%b - %B[%b${vcs_info_msg_0_}%B]%b - %{\e[0;34m%}%B[%b%{\e[0;34m%}'%D{"%a %b %d, %I:%M:%S"}%b$'%{\e[0;34m%}%B]%b%{\e[0m%}
